...
import com.github.akwei.simple.jagent.agent.core.AgentClassBuilder;
import com.github.akwei.simple.jagent.agent.core.DefinitionModule;
import com.github.akwei.simple.jagent.agent.core.ObjectInitializer;
...
public class DemoTest extends BaseActionTest {
    ...
    public void create() throws Exception {
        ...
        Class<?> aClass = byteBuddy.redefine(typePool.describe("com.github.akwei.simple.jagent.agent.component.bean.UserBean").resolve(), classFileLocator)
                .visit(
                        Advice.to(typePool.describe("com.github.akwei.simple.jagent.agent.component.bean.BeanAdvice").resolve(), classFileLocator)
                                .on(named("say"))
                )
                .make()
